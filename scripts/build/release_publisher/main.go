...
func main() {
	...
	flag.StringVar(&version, "version", "", "Plutono version (ex: --version v5.2.0-beta1)")
	flag.StringVar(&whatsNewURL, "wn", "", "What's new url (ex: --wn http://docs.plutono.org/guides/whats-new-in-v5-2/)")
	flag.StringVar(&releaseNotesURL, "rn", "", "Plutono version (ex: --rn https://community.grafana.com/t/release-notes-v5-2-x/7894)")
	...
	if len(os.Args) == 1 {
		...
		fmt.Println("example: go run publisher.go main.go --version v5.2.0-beta2 --wn http://docs.plutono.org/guides/whats-new-in-v5-2/ --rn https://community.grafana.com/t/release-notes-v5-2-x/7894 --apikey ASDF123 --dry-run --enterprise")
		os.Exit(1)
	}
