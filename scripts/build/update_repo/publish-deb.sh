...
RELEASE_TYPE="${1:-}"
GCP_DB_BUCKET="${2:-plutono-aptly-db}"
...
gsutil -m rsync -r /deb-repo/repo/plutono/pool "gs://$GCP_REPO_BUCKET/$RELEASE_TYPE/deb/pool"

gsutil -m rsync -r -d /deb-repo/repo/plutono "gs://$GCP_REPO_BUCKET/$RELEASE_TYPE/deb"
