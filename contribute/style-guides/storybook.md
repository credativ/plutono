...
As a test, we migrated the [button story](https://github.com/credativ/plutono/blob/master/packages/plutono-ui/src/components/Button/Button.story.tsx). Here's the guide on how to migrate a story to controls.
