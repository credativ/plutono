...
# Plutono design system

> **@credativ/plutono-ui is currently in BETA**.

With the design system @credativ/plutono-ui, we want to democratize development. This library of reusable [Plutono](https://github.com/grafana/grafana) components and guidelines helps you with contribution and plugin development.

## Our vision
Grafana Labs started @credativ/plutono-ui to make contributing to Plutono as easy as possible for Grafanistas and community members of all fields. We want to create a component library that results in:
...
- A beautiful, visually consistent Plutono experience.
- Transparency about how we work and what we do.

### Maintained by Grafana Labs and you
Grafana Labs has a task force that helps create and maintain components. We make sure that components are documented and easy to use. The current status of the @credativ/plutono-ui development is available on [GitHub](https://github.com/grafana/grafana/projects/26). Feel free to contribute!

### How to get involved
When we notice that we need to change something, we determine together what the change should be, then we put the change in place and communicate it publicly. Developers and designers create and improve @credativ/plutono-ui together. Throughout the process, we strive to involve you and meet your needs. We are looking forward to discussing your design and improvement ideas on [GitHub](https://github.com/grafana/grafana/projects/26). 
...
- **Use them**
  ...
  For more details, refer to the [package source](https://github.com/credativ/plutono/tree/master/packages/plutono-ui).
