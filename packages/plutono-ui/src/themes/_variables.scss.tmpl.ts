...
import { PlutonoThemeCommons } from '@credativ/plutono-data';
import { renderGeneratedFileBanner } from '../utils/generatedFileBanner';

export const commonThemeVarsTemplate = (theme: PlutonoThemeCommons) =>
  `${renderGeneratedFileBanner('plutono-ui/src/themes/default.ts', 'plutono-ui/src/themes/_variables.scss.tmpl.ts')}
// Options
//
