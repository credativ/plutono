...
import { InfoBox, FeatureInfoBox } from '@credativ/plutono-ui';
...
const defaultProps: FeatureInfoBoxProps = {
  ...
  children: (
    <p>
      ...
      query. Plutono does not validate that queries are safe so queries can contain any SQL statement. For example,
