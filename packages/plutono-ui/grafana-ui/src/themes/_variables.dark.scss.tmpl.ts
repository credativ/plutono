...
export const darkThemeVarsTemplate = (theme: PlutonoTheme) =>
  `${renderGeneratedFileBanner('plutono-ui/src/themes/dark.ts', 'plutono-ui/src/themes/_variables.dark.scss.tmpl.ts')}
// Global values
// --------------------------------------------------
