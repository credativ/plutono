...
export const lightThemeVarsTemplate = (theme: PlutonoTheme) =>
  `${renderGeneratedFileBanner('plutono-ui/src/themes/light.ts', 'plutono-ui/src/themes/_variable.light.scss.tmpl.ts')}
// Global values
// --------------------------------------------------
