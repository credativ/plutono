...
This label component is used in full-page forms in Plutono, for example in the datasource settings. In some parts of Plutono, there are inline forms which do not use this type of label.
