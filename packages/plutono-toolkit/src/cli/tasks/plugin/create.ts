...
const PluginNames: Record<PluginType, string> = {
  'panel-plugin': 'Plutono Panel Plugin',
  'datasource-plugin': 'Plutono Data Source Plugin',
  'backend-datasource-plugin': 'Plutono Backend Datasource Plugin',
};
...
export const printPlutonoTutorialsDetails = (type: PluginType) => {
  ...
  console.log(
    'Learn more about Plutono Plugins at https://grafana.com/docs/grafana/latest/plugins/developing/development/'
  );
  console.log();
  console.groupEnd();
};
