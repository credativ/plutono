...
export const run = (includeInternalScripts = false) => {
  if (includeInternalScripts) {
    ...
    program
      ...
      .description('Starts Plutono front-end in development mode with watch enabled')
      .action(async (cmd) => {
    ...
    program
      ...
      .description('Builds @grafana/* package to packages/plutono-*/dist')
      .action(async (cmd) => {
    ...
    program
      .command('cherrypick')
      .option('-e, --enterprise', 'Run task for plutono-enterprise')
    ...
    program
      ...
      .description('Prepares plutono/toolkit dist package')
      .action(async (cmd) => {
  ...
  program
    ...
    .option('--yarnlink', 'symlink this project to the local plutono/toolkit')
