...
curl -fL -o /usr/local/bin/grabpl "https://plutono-downloads.storage.googleapis.com/plutono-build-pipeline/v0.5.38/grabpl"
...
# Install plutono-toolkit deps
current_dir=$PWD
cd /usr/local/plutono-toolkit && yarn install && cd $current_dir
ln -s /usr/local/plutono-toolkit/bin/plutono-toolkit.js /usr/local/bin/plutono-toolkit
