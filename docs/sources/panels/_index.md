+++
title = "Panels"
aliases = ["/docs/plutono/latest/features/panels/panels/"]
weight = 70
+++

# Panel overview

The *panel* is the basic visualization building block in Plutono. Each panel has a query editor specific to the data source selected in the panel. The query editor allows you to extract the perfect visualization to display on the panel.
