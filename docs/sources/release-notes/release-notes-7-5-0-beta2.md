+++
title = "Release notes for Plutono 7.5.0-beta2"
[_build]
list = false
+++
...
# Release notes for Plutono 7.5.0-beta2
...
* **CloudWatch**: Consume the plutono/aws-sdk. [#31807](https://github.com/grafana/grafana/pull/31807), [@sunker](https://github.com/sunker)
* **CloudWatch**: Restrict auth provider and assume role usage according to Plutono configuration. [#31805](https://github.com/grafana/grafana/pull/31805), [@sunker](https://github.com/sunker)
