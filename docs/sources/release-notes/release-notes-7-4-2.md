+++
title = "Release notes for Plutono 7.4.2"
[_build]
list = false
+++
...
# Release notes for Plutono 7.4.2
...
* **Permissions**: Fix team and role permissions on folders/dashboards not displayed for non Plutono Admin users. [#31132](https://github.com/grafana/grafana/pull/31132), [@AgnesToulet](https://github.com/AgnesToulet)
