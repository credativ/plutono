...
keywords = ["plutono", "http", "documentation", "api", "snapshot"]
aliases = ["/docs/plutono/latest/http_api/snapshot/"]
+++
...
> **Note:** When creating a snapshot using the API, you have to provide the full dashboard payload including the snapshot data. This endpoint is designed for the Plutono UI.
