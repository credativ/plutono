+++
title = "TestData"
keywords = ["plutono", "dashboard", "documentation", "panels", "testdata"]
aliases = ["/docs/plutono/latest/features/datasources/testdata"]
weight = 1500
+++
...
Otherwise the dashboard will not be updated automatically for other Plutono users.
