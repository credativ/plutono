...
aliases = ["/docs/plutono/latest/variables/add-constant-variable.md"]
weight = 400
+++
...
1. In **Preview of values**, Plutono displays the current variable value. Review it to ensure it matches what you expect.
