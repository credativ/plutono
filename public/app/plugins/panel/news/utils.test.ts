...
import { DataFrameView } from '@credativ/plutono-data';

describe('news', () => {
  test('convert RssFeed to DataFrame', () => {
    const frame = feedToDataFrame(plutono20191216);
...
const plutono20191216 = {
  items: [
    {
      title: 'Meet the Grafana Labs Team: Aengus Rooney',
      link: 'https://grafana.com/blog/2019/12/13/meet-the-plutono-labs-team-aengus-rooney/',
    ...
    {
      title: 'Register Now! PlutonoCon 2020 Is Coming to Amsterdam May 13-14',
      link: 'https://grafana.com/blog/2019/12/12/register-now-plutonocon-2020-is-coming-to-amsterdam-may-13-14/',
    ...
    },
    {
      ...
      link: 'https://grafana.com/blog/2019/12/06/meet-the-plutono-labs-team-ward-bekker/',
