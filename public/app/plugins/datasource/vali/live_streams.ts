...
import { ValiTailResponse } from './types';
 ...
 */
export interface ValiLiveTarget {
  query: string;
  url: string;
  refId: string;
  size: number;
...
export class LiveStreams {
  ...
  getStream(target: ValiLiveTarget, retryInterval = 5000): Observable<DataFrame[]> {
