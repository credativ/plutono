...
export default class ValiCheatSheet extends PureComponent<QueryEditorHelpProps, { userExamples: string[] }> {
  ...
  checkUserLabels = async () => {
    ...
    const provider: ValiLanguageProvider = this.props.datasource?.languageProvider;
    if (provider.started) {
