...
import {
  ...
  facetLabels,
  SelectableLabel,
  UnthemedValiLabelBrowser,
  BrowserProps,
} from './ValiLabelBrowser';
...
describe('ValiLabelBrowser', () => {
  const setupProps = (): BrowserProps => {
    ...
    const defaults: BrowserProps = {
      ...
      onChange: () => {},
      autoSelect: 0,
      languageProvider: (mockLanguageProvider as unknown) as ValiLanguageProvider,
    };
  ...
  it('renders and loader shows when empty, and then first set of labels', async () => {
    ...
    render(<UnthemedValiLabelBrowser {...props} />);
