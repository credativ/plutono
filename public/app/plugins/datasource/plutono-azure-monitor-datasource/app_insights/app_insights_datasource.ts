import { DataQueryRequest, DataSourceInstanceSettings, ScopedVars, MetricFindValue } from '@credativ/plutono-data';
import { getBackendSrv, getTemplateSrv, DataSourceWithBackend } from '@credativ/plutono-runtime';
...
export default class AppInsightsDatasource extends DataSourceWithBackend<AzureMonitorQuery, AzureDataSourceJsonData> {
   ...
   * because it's not exposed to Plutono like the main AzureMonitorDataSource.
