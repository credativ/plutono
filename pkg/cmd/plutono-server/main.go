...
import (
	...
	"github.com/credativ/plutono/pkg/extensions"
	"github.com/credativ/plutono/pkg/infra/log"
	"github.com/credativ/plutono/pkg/infra/metrics"
	"github.com/credativ/plutono/pkg/server"
	_ "github.com/credativ/plutono/pkg/services/alerting/conditions"
	_ "github.com/credativ/plutono/pkg/services/alerting/notifiers"
	"github.com/credativ/plutono/pkg/setting"
	_ "github.com/credativ/plutono/pkg/tsdb/azuremonitor"
	_ "github.com/credativ/plutono/pkg/tsdb/cloudmonitoring"
	_ "github.com/credativ/plutono/pkg/tsdb/cloudwatch"
...
func main() {
	var (
		...
		homePath   = flag.String("homepath", "", "path to plutono install/home path, defaults to working directory")
		pidFile    = flag.String("pidfile", "", "path to pid file")
		packaging  = flag.String("packaging", "unknown", "describes the way Plutono was installed")
