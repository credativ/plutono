...
// Override k8s.io/client-go outdated dependency, which is an indirect dependency of plutono/loki.
// It's also present on plutono/loki's go.mod so we'll need till it gets updated.
